...
public class C03_LinkedList {
    public static void main(String[] args) {
        ...
        System.out.println("ll1.remove(\"cuger\") = " + ll1.remove("cuger")); // false case sensetive
        System.out.println("ll1.removeFirst() = " + ll1.removeFirst()); // Cuger
        System.out.println("ll1.removeLast() = " + ll1.removeLast()); // kusssleme
        System.out.println("ll1 removelar sonrasi = " + ll1); //[haşhaşKebap, guzuGerdan, incik]
        ...
        ll1.addAll(ll2); // [haşhaşKebap, guzuGerdan, incik, havuc dilimi, dondurmali irmik, tirilece, kunefe, su muhallebisi, hamsikoy muhallebisi]
        System.out.println("ll1 add all ll2 hali = " + ll1);
        System.out.println("ll1.removeAll(ll2) = " + ll1.removeAll(ll2)); // true
        System.out.println("ll1 = " + ll1); // [haşhaşKebap, guzuGerdan, incik]
