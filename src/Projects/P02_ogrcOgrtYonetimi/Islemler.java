package Projects.P02_ogrcOgrtYonetimi;
...
public class Islemler {
    static List<Ogretmen> ogretmenList = new ArrayList<>();//create edilecek ogrtmen obj saklayacak bos Kisi data type list tanımlandı
    static List<Ogrenci> ogrenciList = new ArrayList<>();//create edilecek ogrenci obj saklayacak bos Kisi data type list tanımlandı
        ...
        if (kisiTuru.equalsIgnoreCase("OGRENCI")) {//kisiTuru oğrenci olma  sartı
            ...
            for (Ogrenci k : ogrenciList) {
                if (k.getKimlikNo().equals(silinecekOgrcNo)) {//silinecek oğrencinin kimlik no'su öğrenciList'te varlık kontrol
                    ...
                    System.out.println("silinecek öğrenci listemizde mevcut değil ");
                }
            }
            System.out.println("OGRENCI ISLEM MENU'ye yönlendiriliyorsunuz");
            islemMenu();
            ...
            for (Ogretmen k : ogretmenList) {
                if (k.getKimlikNo().equals(silinecekOgrtNo)) {//silinecek oğretmenin kimlik no'su öğretmenList'te varlık kontrol
                    ...
                    System.out.println("silinecek muhteşem öğretmenimiz listemizde mevcut değil ");
                }
            }
            System.out.println("OGRETMEN ISLEM MENU'ye yönlendiriliyorsunuz");
            islemMenu();
    ...
    private static void ekle() {
        ...
        if (kisiTuru.equalsIgnoreCase("OGRENCI")) {//kisiTuru oğrenci olma  sartı
            ...
            String ogcAdSoyad = new Scanner(System.in).nextLine();
            // input.nextInt();//dumyy
            ...
            String ogrtAdSoyad = new Scanner(System.in).nextLine();
            //input.nextLine();//dummy
            System.out.print("kimlikNo  giriniz : ");
            // input.nextLine();//dummy
