...
class Test {
    ...
    void checkCard(int cardNo) throws NullPointerException  {  // line n1
        System.out.println("Checking Card");
    }

    public static void main(String[] args) throws ArithmeticException{//yukarida yazildigi icin burayada atmak gerek Exception i
        Test ex = new Test();
        int cardNo = 12344;
        int c=0;
        ex.readCard(cardNo);   // line n2
        System.out.println(cardNo/c);
