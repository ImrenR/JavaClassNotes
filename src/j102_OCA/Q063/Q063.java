...
public class Q063 {
	...
	public	void export() {                      // line n2
	    ...
	    public static void main(String[] args) {
	        Tool aTool = new ReportTool();//Tool referans ama constructor mevcut sadece override edilen metholara ulaşır
	        Tool bTool = new Tool();//sadece Toll 'a methodlar kullanılır child ile ilişki kurmaz
	        callExport(aTool);
	        callExport(bTool);
	    }
